  ...
  <JournalLayout>
    ...
    <div v-if="days.length === 0" class="mb-10 leading-relaxed text-gray-600 dark:text-gray-300">
      <h1 class="text-xl font-semibold text-gray-700 dark:text-gray-300">
        <Icon autosize class="mr-1 text-gray-600 dark:text-gray-400" name="medium/calendar"/>
        Daily Log
      </h1>
      ...
      <p class="mt-4">Empty days are ignored, so if you need to step away for a few days, everything will be here when
        you get back.</p>
