    ...
    <div class="flex flex-col min-h-screen">
      ...
      <nav class="fixed w-full bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700 z-10">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex justify-between h-16">
                ...
                >
                  <template #trigger>
                    <button
                      ...
                      class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 dark:focus:border-gray-500 transition duration-150 ease-in-out"
                    >
                      <img
                    ...
                    >
                      <button
                        type="button"
                        class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-300 bg-white dark:bg-gray-700 hover:text-gray-700 dark:hover:text-gray-100 focus:outline-none transition ease-in-out duration-150"
                      >
            ...
            <div class="-mr-2 flex items-center sm:hidden">
              <button
                class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-900 focus:outline-none focus:bg-gray-100 dark:focus:bg-gray-900 focus:text-gray-500 dark:focus:text-gray-200 transition duration-150 ease-in-out"
        ...
        <div
          ...
          class="sm:hidden justify-end fixed inset-0 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 bg-opacity-75 dark:bg-opacity-75 mt-16"
        >
          <div
